      ...
      <div className="container">
        <div className="row mb-5">
          <div className="col-md-8 col-xl-6 text-center mx-auto">
            <p className="fw-bold secondary-fg mb-2">Bored? Take a look at our
              packages!</p>
            <h2 className="fw-bold primary-fg">Browse packages</h2>
          </div>
        </div>
        <div className="col-10 mx-auto">
          <button className="offset-4 btn">Browse our packages!
          </button>
        </div>
      </div>
    </section>
          ...
          <div className="col-md-6 col-xl-4">
            <div>
              <form className="p-3 p-xlb-4" method="post">
                <div className="mb-3">
                  <input className="form-control" type="text" id="name-1"
                         name="name"
                         placeholder="Name"/>
                </div>
                <div className="mb-3">
                  <input className="form-control" type="email" id="email-1"
                         name="email"
                         placeholder="Email"/>
                </div>
                <div className="mb-3">
                ...
                <div className="mb-3">
                  <input className="form-control" type="text" id="package-1"
                         name="package"
            ...
            <div
              ...
              <div className="d-flex align-items-center p-3">
                ...
                <div className="px-2">
                  ...
                  <p className="text-muted mb-0">Shop No 2 Second Floor, Market,
                    Sewa Nagar, New
                    Delhi, 110003</p>
                </div>
              </div>
